...
$(function(){
	$('#username').blur(function(){
		...
		var msg1=$("#msg1");
		$.getJSON("${pageContext.request.contextPath}/user/user_verifyLoginUsername",{name:username},function(data){
			msg1.text(data[0]);
			if(data[1]=='0'){
				msg1.css('color','red');
			}else{
...
<div class="re-content-box">
        ...
        <div class="re-content-box-left-body">
 		<form action="${pageContext.request.contextPath }/user/loginDo" method="post">
            <div class="re-content-box-left-body-item">
                <input type="text" name="u_account" placeholder="请输入常用手机/邮箱" id="username">
                <p id="msg1" style="height:40px;text-align:left;"></p>
    ...
    <div class="re-content-box-right">
        <h5>还没有账号：</h5>
        <a href="${pageContext.request.contextPath }/user/registerclick" class="login_now">立即注册</a>
        <h5></h5>
        <ul>
