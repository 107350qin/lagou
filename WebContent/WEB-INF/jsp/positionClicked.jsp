...
<div class="top">
	<div class="top_box">
		...
		<div class="right">
			<c:if test="${requestScope.sendOk == 'no'}">
			<a class="a1" href="${pageContext.request.contextPath}/user/sendResume?p_id=${requestScope.positionClicked.p_id}">投个简历</a>
			</c:if>
			<c:if test="${requestScope.sendOk == 'yes'}">
			<a class="a1" href="${pageContext.request.contextPath}/user/cancelSendResume?p_id=${requestScope.positionClicked.p_id}">取消投递</a>
			</c:if>
			<a class="a2" href="${pageContext.request.contextPath}/user/changeResume">完善简历</a>
		</div>
		</c:if>
...
<div class="middle">
	<div class="middle_l">
		<h3>职位描述</h3>
		<p><c:out value="${requestScope.positionClicked.company.com_desc}"></c:out></p>
	</div>
	<div class="middle_r">
